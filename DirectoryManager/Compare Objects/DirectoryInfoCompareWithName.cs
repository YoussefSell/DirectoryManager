namespace System.IO.Expand
{
    ...
    /// between two DirectoryInfo objects. It only compares the name  
    /// of the files being compared.
    /// </summary>
    [Diagnostics.DebuggerStepThrough]
    class DirectoryInfoCompareWithName : IEqualityComparer<DirectoryInfo>
    {
        /// <summary>
        ...
        {
            return dirToLeft.Name == dirToRight.Name;
        }
