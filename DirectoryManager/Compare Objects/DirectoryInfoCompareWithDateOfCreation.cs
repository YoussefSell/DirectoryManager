namespace System.IO.Expand
{
    ...
    /// between two DirectoryInfo objects. It only compares the DateOfCreation   
    /// of the files being compared.
    /// </summary>
    [Diagnostics.DebuggerStepThrough]
    class DirectoryInfoCompareWithDateOfCreation : IEqualityComparer<DirectoryInfo>
    {
        /// <summary>
        ...
        {
            return dirToLeft.CreationTime == dirToRight.CreationTime;
        }
        ...
        {
            return dir.CreationTime.GetHashCode();
        }
    }
}
