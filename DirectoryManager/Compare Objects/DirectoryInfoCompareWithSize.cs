namespace System.IO.Expand
{
    ...
    /// between two DirectoryInfo objects. It only compares the total Size  
    /// of the files being compared.
    /// </summary>
    [Diagnostics.DebuggerStepThrough]
    class DirectoryInfoCompareWithSize : IEqualityComparer<DirectoryInfo>
    {
        /// <summary>
        ...
        {
            return dirToLeft.GetTotalSize() == dirToRight.GetTotalSize();
        }
